	...
	<div class="row topnav-row">
		<div class="navbar" id="nav-main">
			<div class="navbar-inner">
				...
				<a href="home">
					<img class="col-md-4" id="topnav-logo" ng-class="{'logoCenter' : $scope.where = '/' && ('#scroll-box').scrollTop() <= 50 , 'logoLeft' : $scope.where != '/' || ('#scroll-box').scrollTop() > 50 }" src="media/kg-icon-placeholder.png" />
